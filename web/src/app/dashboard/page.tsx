    ...
    if (!blocklists && !activeSession) {
        return (
            <div className="min-h-screen bg-[#020617] flex flex-col items-center justify-center p-6 text-center space-y-6">
                <div className="w-16 h-16 rounded-3xl bg-red-500/10 border-2 border-red-500/20 flex items-center justify-center animate-pulse">
                    <Zap className="text-red-500 fill-red-500/50 animate-bounce" size={24} />
                </div>
                <div className="space-y-2">
                    <h2 className="text-xl font-black text-white tracking-normal uppercase">Connecting to NoEscape...</h2>
                    <p className="text-xs font-bold text-slate-500 uppercase tracking-normal max-w-sm">
        ...
        <div className="min-h-screen bg-[#020617] text-slate-200 font-sans selection:bg-red-500/30">
                ...
                <div className="max-w-[1600px] mx-auto px-6 h-16 flex items-center justify-between">
                    <div className="flex items-center gap-8">
                        <div className="flex items-center gap-2">
                            ...
                            <span className="text-xl font-black tracking-normal text-white">NoEscape</span>
                        </div>
                        <div className="h-6 w-px bg-white/10 hidden md:block" />
                        <div className="hidden md:flex items-center gap-6">
                            {['Dashboard', 'Devices', 'Sync', 'Help'].map((link) => (
                                <a key={link} href="#" className="text-sm font-medium text-slate-400 hover:text-red-400 transition-colors uppercase tracking-normal">{link}</a>
                            ))}
                        </div>
                    </div>
                    <div className="flex items-center gap-4">
                        ...
                        <div className="w-10 h-10 rounded-full bg-slate-800 border border-white/10 flex items-center justify-center text-red-400 font-black">
                ...
                <aside className="md:col-span-1 lg:col-span-1 space-y-10">
                    ...
                    <section className="space-y-4">
                        <div className="flex justify-between items-center group">
                            <h3 className="text-xs font-black text-slate-500 uppercase tracking-normal group-hover:text-slate-400 transition-colors">My Devices</h3>
                            <button className="text-[10px] font-bold text-red-500 hover:text-red-400 flex items-center gap-1">
                                ADD <PlusCircle size={12} />
                            </button>
                        </div>
                        <div className="space-y-2">
                            <div className="p-4 rounded-2xl bg-slate-900/50 border border-white/5 flex items-center gap-3 group hover:border-red-500/30 transition-all">
                                <div className="w-2 h-2 rounded-full bg-emerald-500 shadow-[0_0_8px_rgba(16,185,129,0.5)] animate-pulse" />
                                <div className="flex-1">
                                    <p className="text-sm font-bold text-white uppercase tracking-normal">Main Workstation</p>
                                    <p className="text-[10px] text-slate-500 font-medium">Windows 11 • Active</p>
                                </div>
                                <Monitor size={16} className="text-slate-700 group-hover:text-red-500/50 transition-colors" />
                            </div>
                        </div>
                    </section>
                    ...
                    {/* Options */}
                    <section className="space-y-4">
                        <h3 className="text-xs font-black text-slate-500 uppercase tracking-normal">Protection Options</h3>
                        <div className="p-5 rounded-3xl bg-slate-900/50 border border-white/5 space-y-6">
                            <div className="flex items-center justify-between">
                                <div className="flex items-center gap-3">
                                    <Shield size={18} className={cn(lockedMode ? "text-red-400" : "text-slate-600")} />
                                ...
                                <button
                                    ...
                                    className={cn(
                                        ...
                                        lockedMode ? "bg-red-600" : "bg-slate-800"
                                    )}
                                >
                                    <div className={cn(
                    ...
                    {/* Tour Card */}
                    <button className="w-full p-5 rounded-3xl bg-red-600 hover:bg-red-500 transition-all shadow-xl shadow-red-900/40 flex items-center justify-center gap-3 text-white font-black text-xs uppercase tracking-normal group active:scale-95">
                    ...
                    <section className="bg-slate-900/30 border border-white/5 rounded-[3rem] overflow-hidden backdrop-blur-sm">
                        <div className="bg-slate-900/50 px-8 py-2 border-b border-white/5 flex gap-8">
                            <button
                                ...
                                className={cn(
                                    "text-xs font-black uppercase tracking-normal py-4 border-b-2 transition-all",
                                    activeTab === 'sessions' ? "border-red-500 text-white" : "border-transparent text-slate-500 hover:text-slate-300"
                                )}
                            >My Sessions</button>
                            <button
                                ...
                                className={cn(
                                    "text-xs font-black uppercase tracking-normal py-4 border-b-2 transition-all",
                                    activeTab === 'history' ? "border-red-500 text-white" : "border-transparent text-slate-500 hover:text-slate-300"
                                )}
                            ...
                            {activeTab === 'sessions' ? (
                                <>
                                    <div className="flex items-center gap-3">
                                        ...
                                        <h2 className="text-xl font-black uppercase tracking-normal">Add Session</h2>
                                    </div>
                                    ...
                                    <div className="space-y-8">
                                        ...
                                        <div className="flex gap-8 border-b border-white/5 pb-1">
                                            {['Start now', 'Start later', 'Recurring session'].map((t) => (
                                                <button
                                                    ...
                                                    className={cn(
                                                        "text-[10px] font-black uppercase tracking-normal pb-3 border-b-2 transition-all",
                                        ...
                                        {activeSession?.active ? (
                                            <div className="bg-slate-900/80 backdrop-blur-xl border-2 border-red-500/50 rounded-[2.5rem] p-10 flex flex-col md:flex-row items-center justify-between gap-8 animate-pulse-glow neon-glow shadow-2xl shadow-red-500/20">
                                                <div className="space-y-4">
                                                    <div className="flex items-center gap-3 px-3 py-1 bg-red-500/20 text-red-400 border border-red-500/30 rounded-full w-max">
                                                        <div className="w-1.5 h-1.5 rounded-full bg-red-500 animate-ping" />
                                                        <span className="text-[10px] font-black uppercase">Active Enforcement</span>
                                                    </div>
                                                    <div className="space-y-0">
                                                        <p className="text-[10px] font-black text-red-500/50 uppercase tracking-normal">Global Timer</p>
                                                        <h3 className="text-7xl font-black font-mono text-white tracking-normal">
                                                ...
                                                <button
                                                    ...
                                                    className="px-10 py-5 bg-red-600 hover:bg-red-500 text-white rounded-2xl font-black uppercase text-sm tracking-normal shadow-xl shadow-red-900/40 active:scale-95 transition-all"
                                                >
                                                    Stop Session
                                                </button>
                                            </div>
                                            ...
                                            <div className="grid grid-cols-1 xl:grid-cols-2 gap-10">
                                                ...
                                                <div className="bg-slate-900/50 border border-white/5 p-8 rounded-3xl space-y-8">
                                                    <div className="flex flex-col gap-4">
                                                        <div className="space-y-2">
                                                            <p className="text-[10px] font-black text-slate-500 uppercase tracking-normal">Select Block Duration</p>
                                                            <select
                                                                className="w-full bg-slate-800 border-2 border-slate-700 hover:border-red-500/50 rounded-xl p-4 text-sm font-black text-white focus:ring-2 focus:ring-red-500 outline-none transition-all cursor-pointer appearance-none"
                                                        ...
                                                        <button
                                                            ...
                                                            className="flex-1 py-5 bg-emerald-600 hover:bg-emerald-500 disabled:opacity-30 text-white rounded-2xl font-black uppercase text-sm tracking-normal shadow-xl shadow-emerald-900/40 active:scale-[0.98] transition-all"
                                                        >
                                                    ...
                                                    {/* Block Selection */}
                                                    <div className="space-y-4">
                                                        <p className="text-[10px] font-black text-slate-500 uppercase tracking-normal">Block these distractions:</p>
                                                        <div className="relative">
                                                            <select
                                                                value={selectedBlocklistIds[0] || ""}
                                                                onChange={(e) => setSelectedBlocklistIds([e.target.value])}
                                                                className="w-full bg-slate-800/80 border-2 border-slate-700 hover:border-red-500/50 rounded-xl p-4 pr-10 text-sm font-black text-white focus:ring-2 focus:ring-red-500 outline-none cursor-pointer appearance-none transition-all shadow-lg shadow-black/20"
                                                            >
                                                ...
                                                <div className="bg-slate-900/50 border border-white/5 p-8 rounded-3xl space-y-4">
                                                    <p className="text-[10px] font-black text-slate-500 uppercase tracking-normal">Enforce on these devices:</p>
                                                    <div className="space-y-3">
                                                        <div className="p-4 rounded-xl bg-slate-800/50 border border-red-500/30 flex items-center gap-4">
                                ...
                                <div className="space-y-4 max-h-[500px] overflow-y-auto custom-scrollbar pr-2">
                                    {sessionHistory && sessionHistory.length > 0 ? (
                                        sessionHistory.map((session: any) => (
                                            <div key={session.id} className="p-6 bg-slate-900/50 border border-white/5 hover:border-red-500/30 rounded-2xl transition-all flex items-center justify-between group">
                                                <div className="flex items-center gap-4">
                                                    <div className="w-10 h-10 rounded-xl bg-red-500/10 border border-red-500/20 flex items-center justify-center text-red-400">
                                                        <History size={18} />
                                                    </div>
                                                    <div>
                                                        <p className="text-sm font-bold text-white uppercase tracking-normal">
                                                            {new Date(session.start_time).toLocaleDateString(undefined, { weekday: 'long', month: 'short', day: 'numeric' })}
                                                        </p>
                                                        <p className="text-[10px] text-slate-500 uppercase tracking-normal font-black mt-1">
                                                ...
                                                <div className="text-right">
                                                    <div className="inline-flex items-center gap-2 px-3 py-1 bg-slate-950 border border-white/5 rounded-lg mb-1">
                                                        ...
                                                        <span className="text-[10px] font-black text-slate-400 tracking-normal uppercase">{session.blocklist?.name || 'Unknown List'}</span>
                                                    </div>
                                        ...
                                        <div className="space-y-6 text-center py-10">
                                            ...
                                            <div className="space-y-2">
                                                ...
                                                <p className="text-slate-500 max-w-sm mx-auto text-xs uppercase tracking-normal">Your deep work history will appear here once you complete your first focus session.</p>
                                            </div>
                                        </div>
                                    )}
                                </div>
                    ...
                    <section className="space-y-8">
                        <div className="flex justify-between items-end">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <h2 className="text-2xl font-black uppercase tracking-normal">My Blocklists</h2>
                                    <p className="text-xs font-bold text-slate-600 uppercase tracking-normal">Guardian profiles for focus</p>
                                </div>
                            </div>
                            <button
                                onClick={() => { setIsCreatingList(true); setEditingListId(null); }}
                                className="px-6 py-3 bg-white text-slate-950 hover:bg-slate-200 rounded-2xl text-xs font-black uppercase tracking-normal transition-all active:scale-95 shadow-lg shadow-white/5"
                            >
                        ...
                        {isCreatingList && (
                            <div className="bg-slate-900 border-2 border-red-500/30 rounded-[2.5rem] p-8 lg:p-10 space-y-10 animate-in slide-in-from-top-4 duration-300 shadow-2xl shadow-red-900/20">
                                <div className="flex justify-between items-center">
                                    <h3 className="text-xl font-black italic uppercase tracking-normal text-red-400">
                                ...
                                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                                    <div className="space-y-8">
                                        <div className="space-y-4">
                                            <p className="text-xs font-black text-slate-500 uppercase tracking-normal">List Name</p>
                                            <input
                                                value={newListName} onChange={(e) => setNewListName(e.target.value)}
                                                placeholder="e.g. Deep Work, No Social Media"
                                                className="w-full bg-slate-950 border border-white/10 rounded-2xl p-4 text-xl font-black text-white focus:ring-2 focus:ring-red-500 outline-none transition-all"
                                            />
                                        </div>

                                        <div className="space-y-4">
                                            <p className="text-xs font-black text-slate-500 uppercase tracking-normal">Your Custom Websites</p>
                                            <div className="flex gap-4">
                                                <input
                                                    value={customDomain} onChange={(e) => setCustomDomain(e.target.value)}
                                                    placeholder="e.g. youtube.com"
                                                    className="flex-1 bg-slate-950 border border-white/10 rounded-xl p-4 font-bold text-white focus:ring-2 focus:ring-red-500 outline-none"
                                                />
                                                <button
                                                    onClick={() => {
                                                    ...
                                                    className="px-8 bg-red-600 hover:bg-red-500 rounded-xl font-black uppercase text-[10px] tracking-normal transition-all"
                                                >Add Site</button>
                                            </div>
                                        </div>

                                        <div className="space-y-4">
                                            <p className="text-xs font-black text-slate-500 uppercase tracking-normal">Selected Domains</p>
                                            <div className="flex flex-wrap gap-2">
                                                {selectedDomains.map((d, i) => (
                                                    <span key={i} className="px-2 py-1 bg-slate-800 text-[10px] font-black text-red-300 rounded uppercase flex items-center gap-1">
                                        ...
                                        <div className="space-y-4 pt-4 border-t border-white/5">
                                            <div className="space-y-4">
                                                <p className="text-xs font-black text-slate-500 uppercase tracking-normal">System Applications</p>
                                                <div className="flex gap-4">
                                                    <input
                                    ...
                                    <div className="space-y-8">
                                        <div className="space-y-4">
                                            <p className="text-xs font-black text-slate-500 uppercase tracking-normal">Common Filters</p>
                                            <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
                                                {COMMON_FILTERS.map(f => (
                                                    <button key={f.name} onClick={() => setSelectedDomains(prev => Array.from(new Set([...prev, ...f.domains])))} className="p-3 bg-slate-950/50 border border-white/5 rounded-xl hover:border-red-500/50 hover:bg-red-500/5 transition-all text-left flex items-center justify-between group">
                                                        <span className="text-xs font-bold text-slate-400 group-hover:text-red-400 transition-colors">{f.name}</span>
                                                        <Plus size={12} className="text-slate-700 group-hover:text-red-500" />
                                                    </button>
                                                ))}
                                            </div>
                                        </div>
                                        ...
                                        <div className="space-y-4">
                                            <p className="text-xs font-black text-slate-500 uppercase tracking-normal">Category Filters</p>
                                            <div className="grid grid-cols-2 gap-3">
                                                {CATEGORY_FILTERS.map(c => (
                                                    <button key={c.name} onClick={() => setSelectedDomains(prev => Array.from(new Set([...prev, ...c.domains])))} className="p-3 bg-slate-950/50 border border-white/5 rounded-xl hover:border-red-500/50 hover:bg-red-500/5 transition-all text-left flex items-center justify-between group">
                                                        <span className="text-xs font-bold text-slate-400 group-hover:text-red-400 transition-colors">{c.name}</span>
                                                        <PlusCircle size={14} className="text-slate-700 group-hover:text-red-500" />
                                                    </button>
                                                ))}
                                            </div>
                                        </div>
                                ...
                                <div className="pt-8 border-t border-white/5 flex justify-end gap-4">
                                    ...
                                    <button
                                        ...
                                        className="px-12 py-3 bg-red-600 hover:bg-red-500 disabled:opacity-50 text-white rounded-xl font-black uppercase text-xs tracking-normal transition-all shadow-xl shadow-red-900/40"
                                    >
                                        Save Blocklist
                                    </button>
                                </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                            {blocklists?.map((list: any) => (
                                <div key={list.id} className="group bg-slate-900/60 border border-white/5 p-8 rounded-[2rem] hover:bg-slate-900/80 hover:border-red-500/80 hover:neon-glow transition-all duration-300 relative overflow-hidden backdrop-blur-md">
                                    ...
                                    <div className="flex justify-between items-start relative z-10 sm-6">
                                        <div className="space-y-1 mb-6">
                                            <div className="flex items-center gap-2">
                                                ...
                                                <h3 className="text-xl font-black text-white uppercase tracking-normal">{list.name}</h3>
                                            </div>
                                            <p className="text-[10px] font-black text-slate-600 uppercase tracking-normal">
                                    ...
                                    <div className="space-y-4 relative z-10 pt-4 border-t border-white/5">
                                        ...
                                        <button
                                            ...
                                            className="text-[10px] font-black text-red-500/60 hover:text-red-500 uppercase tracking-normal flex items-center gap-1 transition-colors"
                                        >
            ...
            <footer className="max-w-[1600px] mx-auto p-10 mt-20 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-6">
                <div className="flex items-center gap-2 opacity-30">
                    ...
                    <span className="text-xs font-black uppercase tracking-normal text-white">NoEscape v1.0.42</span>
                </div>
                <div className="flex gap-8">
                    {['Status', 'Privacy', 'Terms', 'Support'].map(f => (
                        <a key={f} href="#" className="text-[10px] font-black uppercase tracking-normal text-slate-600 hover:text-red-500 transition-colors">{f}</a>
                    ))}
                </div>
                <span className="text-[10px] font-bold text-slate-700 uppercase tracking-normal">© 2026 DIGITAL_DISCIPLINE_LABS</span>
            </footer>
